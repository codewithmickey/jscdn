var Navigation = function(){
    ...
    function setNextBack(current,total){
        ...
        if (current == total -1) {
            ...
            // $('a.access_anchor_next').addClass('disabled');
        }

        // else if(current < total -1){
        //     $('a[menu-data = '+'Next'+']').removeClass('disabled');
        //     // $('a.access_anchor_next').removeClass('disabled');
        // }
    ...
    function addButtonEvents() {
        _html.find('a').on("click", function(){
            // $('.nav_link_next_access, .nav_link_back_access').on('keypress', function(e){
    ...
    function generateList(nCurrentLetter) {
        ...
        $(document).ready(function() {
            $.getJSON( "assets/json/config.json", function( data ) {
                $('#terms_0, #terms_1, #terms_6, #terms_7, #terms_8').unbind('keypress').bind('keypress', function(e){
