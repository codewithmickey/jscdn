    ...
    function generateList(nCurrentLetter) {
        ...
        $(document).ready(function() {
            $.getJSON( "assets/json/config.json", function( data ) {
                $('#terms_0, #terms_1, #terms_2, #terms_3, #terms_4, #terms_5, #terms_6, #terms_7, #terms_8, #terms_9, #terms_10, #terms_11, #terms_12, #terms_13').unbind('keypress').bind('keypress', function(e){
