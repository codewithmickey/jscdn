var quiz = function(dom,data){
    ...
    function construct(){
        ...
        _html = dom
        _html.find('.quiz__section__main_mod6').html(data.content)
    ...
    construct()
        ...
        _html.find('#start__quiz').on('click', function(e) {
            ...
            _html.find('quiz_prev_mod6').addClass('disabled');
            $('img.quiz_prev_mod6').attr("tabindex", -1);
            $('footer').hide()
            $('nextback').hide()
        ...
        function loadQuiz() {
            ...
            if(attemptedQuestionCounter == nCurrentQuestion && retakeQuizFlag == false){
                $('.quiz_next_mod6').addClass('disabled');
                $('img.quiz_next_mod6').attr("tabindex", -1);
            }else{
                $('.quiz_next_mod6').removeClass('disabled');
                $('img.quiz_next_mod6').attr("tabindex", 0);
            }
        ...
        _html.find('#review__quiz').on('click', function(e){
            ...
            $('.quiz_prev_mod6').addClass('disabled');
            $('img.quiz_prev_mod6').attr("tabindex", -1);
            $('.quiz_next_mod6').removeClass('disabled');
            $('img.quiz_next_mod6').attr("tabindex", 0);
            loadQuiz();
        ...
        _html.find('#submit_question').on('click', function(e) {
            ...
            if(validate()) {
                ...
                if(submittedQuestionCounter == 1){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#ffffff");
                    $('.pagination_circle3_mod6').css("background", "#ffffff");
                    $('.pagination_circle4_mod6').css("background", "#ffffff");
                    $('.pagination_circle5_mod6').css("background", "#ffffff");
                    $('.pagination_circle6_mod6').css("background", "#ffffff");
                    $('.pagination_circle7_mod6').css("background", "#ffffff");
                    $('.pagination_circle8_mod6').css("background", "#ffffff");
                    $('.pagination_circle9_mod6').css("background", "#ffffff");
                    $('.pagination_circle10_mod6').css("background", "#ffffff");
                    $('.pagination_circle11_mod6').css("background", "#ffffff");
                    $('.pagination_circle12_mod6').css("background", "#ffffff");
                    $('.pagination_circle13_mod6').css("background", "#ffffff");
                    $('.pagination_circle14_mod6').css("background", "#ffffff");
                    $('.pagination_circle15_mod6').css("background", "#ffffff");
                    $('.pagination_circle16_mod6').css("background", "#ffffff");
                    $('.pagination_circle17_mod6').css("background", "#ffffff");
                    $('.pagination_circle18_mod6').css("background", "#ffffff");
                    $('.pagination_circle19_mod6').css("background", "#ffffff");
                    $('.pagination_circle20_mod6').css("background", "#ffffff");
                }else if(submittedQuestionCounter == 2){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#ffffff");
                    $('.pagination_circle4_mod6').css("background", "#ffffff");
                    $('.pagination_circle5_mod6').css("background", "#ffffff");
                    $('.pagination_circle6_mod6').css("background", "#ffffff");
                    ...
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#ffffff");
                    $('.pagination_circle5_mod6').css("background", "#ffffff");
                    $('.pagination_circle6_mod6').css("background", "#ffffff");
                    $('.pagination_circle7_mod6').css("background", "#ffffff");
                    ...
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    $('.pagination_circle5_mod6').css("background", "#ffffff");
                    $('.pagination_circle6_mod6').css("background", "#ffffff");
                    $('.pagination_circle7_mod6').css("background", "#ffffff");
                    $('.pagination_circle8_mod6').css("background", "#ffffff");
                    ...
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    $('.pagination_circle5_mod6').css("background", "#3087C8");
                    $('.pagination_circle6_mod6').css("background", "#ffffff");
                    $('.pagination_circle7_mod6').css("background", "#ffffff");
                    $('.pagination_circle8_mod6').css("background", "#ffffff");
                    $('.pagination_circle9_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 6){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    $('.pagination_circle5_mod6').css("background", "#3087C8");
                    $('.pagination_circle6_mod6').css("background", "#3087C8");
                    $('.pagination_circle7_mod6').css("background", "#ffffff");
                    $('.pagination_circle8_mod6').css("background", "#ffffff");
                    $('.pagination_circle9_mod6').css("background", "#ffffff");
                    $('.pagination_circle10_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 7){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    $('.pagination_circle5_mod6').css("background", "#3087C8");
                    $('.pagination_circle6_mod6').css("background", "#3087C8");
                    $('.pagination_circle7_mod6').css("background", "#3087C8");
                    $('.pagination_circle8_mod6').css("background", "#ffffff");
                    $('.pagination_circle9_mod6').css("background", "#ffffff");
                    $('.pagination_circle10_mod6').css("background", "#ffffff");
                    $('.pagination_circle11_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 8){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle6_mod6').css("background", "#3087C8");
                    $('.pagination_circle7_mod6').css("background", "#3087C8");
                    $('.pagination_circle8_mod6').css("background", "#3087C8");
                    $('.pagination_circle9_mod6').css("background", "#ffffff");
                    $('.pagination_circle10_mod6').css("background", "#ffffff");
                    $('.pagination_circle11_mod6').css("background", "#ffffff");
                    $('.pagination_circle12_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 9){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle7_mod6').css("background", "#3087C8");
                    $('.pagination_circle8_mod6').css("background", "#3087C8");
                    $('.pagination_circle9_mod6').css("background", "#3087C8");
                    $('.pagination_circle10_mod6').css("background", "#ffffff");
                    $('.pagination_circle11_mod6').css("background", "#ffffff");
                    $('.pagination_circle12_mod6').css("background", "#ffffff");
                    $('.pagination_circle13_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 10){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle8_mod6').css("background", "#3087C8");
                    $('.pagination_circle9_mod6').css("background", "#3087C8");
                    $('.pagination_circle10_mod6').css("background", "#3087C8");
                    $('.pagination_circle11_mod6').css("background", "#ffffff");
                    $('.pagination_circle12_mod6').css("background", "#ffffff");
                    $('.pagination_circle13_mod6').css("background", "#ffffff");
                    $('.pagination_circle14_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 11){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle9_mod6').css("background", "#3087C8");
                    $('.pagination_circle10_mod6').css("background", "#3087C8");
                    $('.pagination_circle11_mod6').css("background", "#3087C8");
                    $('.pagination_circle12_mod6').css("background", "#ffffff");
                    $('.pagination_circle13_mod6').css("background", "#ffffff");
                    $('.pagination_circle14_mod6').css("background", "#ffffff");
                    $('.pagination_circle15_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 12){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle10_mod6').css("background", "#3087C8");
                    $('.pagination_circle11_mod6').css("background", "#3087C8");
                    $('.pagination_circle12_mod6').css("background", "#3087C8");
                    $('.pagination_circle13_mod6').css("background", "#ffffff");
                    $('.pagination_circle14_mod6').css("background", "#ffffff");
                    $('.pagination_circle15_mod6').css("background", "#ffffff");
                    $('.pagination_circle16_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 13){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle11_mod6').css("background", "#3087C8");
                    $('.pagination_circle12_mod6').css("background", "#3087C8");
                    $('.pagination_circle13_mod6').css("background", "#3087C8");
                    $('.pagination_circle14_mod6').css("background", "#ffffff");
                    $('.pagination_circle15_mod6').css("background", "#ffffff");
                    $('.pagination_circle16_mod6').css("background", "#ffffff");
                    $('.pagination_circle17_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 14){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle12_mod6').css("background", "#3087C8");
                    $('.pagination_circle13_mod6').css("background", "#3087C8");
                    $('.pagination_circle14_mod6').css("background", "#3087C8");
                    $('.pagination_circle15_mod6').css("background", "#ffffff");
                    $('.pagination_circle16_mod6').css("background", "#ffffff");
                    $('.pagination_circle17_mod6').css("background", "#ffffff");
                    $('.pagination_circle18_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 15){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle13_mod6').css("background", "#3087C8");
                    $('.pagination_circle14_mod6').css("background", "#3087C8");
                    $('.pagination_circle15_mod6').css("background", "#3087C8");
                    $('.pagination_circle16_mod6').css("background", "#ffffff");
                    $('.pagination_circle17_mod6').css("background", "#ffffff");
                    $('.pagination_circle18_mod6').css("background", "#ffffff");
                    $('.pagination_circle19_mod6').css("background", "#ffffff");
                ...
                else if(submittedQuestionCounter == 16){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle14_mod6').css("background", "#3087C8");
                    $('.pagination_circle15_mod6').css("background", "#3087C8");
                    $('.pagination_circle16_mod6').css("background", "#3087C8");
                    $('.pagination_circle17_mod6').css("background", "#ffffff");
                    $('.pagination_circle18_mod6').css("background", "#ffffff");
                    $('.pagination_circle19_mod6').css("background", "#ffffff");
                    $('.pagination_circle20_mod6').css("background", "#ffffff");
                }
                else if(submittedQuestionCounter == 17){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle15_mod6').css("background", "#3087C8");
                    $('.pagination_circle16_mod6').css("background", "#3087C8");
                    $('.pagination_circle17_mod6').css("background", "#3087C8");
                    $('.pagination_circle18_mod6').css("background", "#ffffff");
                    $('.pagination_circle19_mod6').css("background", "#ffffff");
                    $('.pagination_circle20_mod6').css("background", "#ffffff");
                }
                else if(submittedQuestionCounter == 18){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle16_mod6').css("background", "#3087C8");
                    $('.pagination_circle17_mod6').css("background", "#3087C8");
                    $('.pagination_circle18_mod6').css("background", "#3087C8");
                    $('.pagination_circle19_mod6').css("background", "#ffffff");
                    $('.pagination_circle20_mod6').css("background", "#ffffff");
                }
                else if(submittedQuestionCounter == 19){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle17_mod6').css("background", "#3087C8");
                    $('.pagination_circle18_mod6').css("background", "#3087C8");
                    $('.pagination_circle19_mod6').css("background", "#3087C8");
                    $('.pagination_circle20_mod6').css("background", "#ffffff");
                }
                else if(submittedQuestionCounter == 20){
                    $('.pagination_circle1_mod6').css("background", "#3087C8");
                    $('.pagination_circle2_mod6').css("background", "#3087C8");
                    $('.pagination_circle3_mod6').css("background", "#3087C8");
                    $('.pagination_circle4_mod6').css("background", "#3087C8");
                    ...
                    $('.pagination_circle18_mod6').css("background", "#3087C8");
                    $('.pagination_circle19_mod6').css("background", "#3087C8");
                    $('.pagination_circle20_mod6').css("background", "#3087C8");
                }
            }
        });
        ...
        _html.find('#next_question').on('click', function(e) {
            ...
            if(!$("#next_question").hasClass("disabled")){
                ...
                if(validate()) {
                        ...
                        case "MCMS":
                            ...
                            if($("img").hasClass("disabled")){
                                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex + 1 > 0){
                                    $("img.quiz_prev_mod6").removeClass("disabled");
                                    $('img.quiz_prev_mod6').attr("tabindex", 0);
                                }
                            }
                            break;
                    }
                    ...
                    $('.quiz_prev_mod6').removeClass('disabled');
                    $('img.quiz_prev_mod6').attr("tabindex", 0);
        ...
        _html.find('.quiz_prev_mod6').on('click', function(e){
            if(!$("img.quiz_prev_mod6").hasClass("disabled")){
                nCurrentQuestion--;
                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex == 0){
                    $("img.quiz_prev_mod6").addClass("disabled");
                    $('img.quiz_prev_mod6').attr("tabindex", -1);
                }
                $('#next_question').removeClass("hide")
        ...
        _html.find('.quiz_next_mod6').on('click', function(e){
            if(!$("img.quiz_next_mod6").hasClass("disabled") && retakeQuizFlag == false){
                nCurrentQuestion++;
                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex == 4){
                    $("img.quiz_next_mod6").addClass("disabled");
                    $('img.quiz_next_mod6').attr("tabindex", -1);
                }
                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex > 0){
                    $("img.quiz_prev_mod6").removeClass("disabled");
        ...
        function displayScoreBoard() {
            ...
            if(percentage>=80) {
                ...
                $('#scoreboard__title').attr('tabindex',-1)
                _html.find('#scoreboard__title_numbers').html('<p><b>This is the end of the quiz.</b></p><p><b>To pass you need a minimum of 16 correct answers.</b></p>');
                _html.find('#scoreboard__title_text').html('<p>Given below is your score.</p>');
                _html.find('.pcc_percents_wrapper').html(''+counter+' of '+jsonData.Assessment.length+'');
        ...
        _html.find('#retake__quiz').on('click', function(e) {
            ...
            $('.quiz_prev_mod6').addClass('disabled');
            $('img.quiz_prev_mod6').attr('tabindex',-1);
            $('.pagination_circle1_mod6').css("background", "#ffffff");
            $('.pagination_circle2_mod6').css("background", "#ffffff");
            $('.pagination_circle3_mod6').css("background", "#ffffff");
            $('.pagination_circle4_mod6').css("background", "#ffffff");
            $('.pagination_circle5_mod6').css("background", "#ffffff");
    ...
    $(document).ready(function() {
        $.getJSON( "assets/json/config.json", function( data ) {
            $('.quiz_prev_mod6, .quiz_next_mod6').unbind('keypress').bind('keypress', function(e){
