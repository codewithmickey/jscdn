(function(app) {
    ...
    function startApplication(){
        ...
        oContentLoader.evts.addEventListener("FLIPCARD_CLICKED", function(a,b,c){
            if(c==true){
                screen3_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("INVESTIGATIONS_CLICKED", function(a,b,c){
            if(c==true){
                screen6_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("CLICKANDREVEAL_ACTIVITY_CLICKED", function(a,b,c){
            if(c==true){
                screen7_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("SCENARIO_OCUPATIONAL_ACTIVITY_CLICKED", function(a,b,c){
            if(c==true){
                screen8_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("INVESTIGATION_OCUPATIONAL_ACTIVITY_CLICKED", function(a,b,c){
            if(c==true){
                screen9_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("SCENARIO_AVIATION_ACTIVITY_CLICKED", function(a,b,c){
            if(c==true){
                screen10_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("INVESTIGATION_AVIATION_ACTIVITY_CLICKED", function(a,b,c){
            if(c==true){
                screen11_flag = true;
            }
            setEnableMenu();
        ...
        document.addEventListener('swiped-left', function(e) {
            if(nCurrentPage <  nTotalPages-1){
                ...
                // counter++;
                setPageNumber();
                _html.find('.transcript_data_mod3').addClass("hide");
                transcriptOn = false;
                // loadPage();
            }
        });
    ...
    function createNavigation(){
        ...
        oNavigation.evts.addEventListener("NAV_CLICKED",function(a,b,c){
            ...
            if(!isNaN(c) && !$('a[menu-data = '+c+']').hasClass("disabled"))
            {
                ...
                $('.transcript_data_mod3').addClass("hide");
                $('.close_text_area_mod3').addClass("hide");
            ...
            }else if(c == "Glossary")
            {
                ...
                setPageNumber();
                //Accessibility Code for Menu
                $('.menuitem_1, .menuitem_2, .menuitem_3, .menuitem_4, .menuitem_5, .menuitem_6, .menuitem_7, .menuitem_8, .menuitem_9, .menuitem_10, .menuitem_11, .menuitem_12, .menuitem_13').unbind('keypress').bind('keypress', function(e){
    ...
    function setSuspendedData(){
        suspendData = nCurrentPage+"<||>"+screen1_flag+"<||>"+screen2_flag+"<||>"+screen3_flag+"<||>"+screen4_flag+"<||>"+screen5_flag+"<||>"+screen6_flag+"<||>"+screen7_flag+"<||>"+screen8_flag+"<||>"+screen9_flag+"<||>"+screen10_flag+"<||>"+screen11_flag+"<||>"+screen12_flag+"<||>"+screen13_flag;
    ...
    function setNextEnable(){
        if(screen1_flag == true && nCurrentPage==1){
            ...
            $('a[menu-data = '+'Next'+']').addClass('disabled');
        }else if(screen13_flag == false && nCurrentPage==13){
            $('a[menu-data = '+'Next'+']').addClass('disabled');
        }else{
            setTimeout(function(){
                $('a[menu-data = '+'Next'+']').addClass('disabled');  
    ...
    function activateAudioPlayer(){
        ...
        $('.click_cursor_unmute, .click_cursor_mute, .click_cursor_play, .click_cursor_pause, .click_cursor_replay, .click_cursor_text').unbind('keypress').bind('keypress', function(e){
            if(e.type === 'keypress' && e.keyCode != 13 && e.keyCode != 32 && e.keyCode != 9){
                return false;
            } 
            if(e.keyCode !=9){
        ...
        _html.find('.click_cursor_text').click(function(){
            if(!transcriptOn){
                $('.transcript_data_mod3  > p').html('');
                $('.transcript_data_mod3').removeClass("hide");
                $('.transcript_data_mod3 > p').append(jsonData.pages[nCurrentPage].data.transcript);
                $('.close_text_area_mod3').removeClass("hide");
        ...
        $('.close_text_area_mod3').click(function(){
            $('.transcript_data_mod3').addClass("hide");
            $('.close_text_area_mod3').addClass("hide");
            $('.audio__control').removeClass("hide");
            transcriptOn = false;
