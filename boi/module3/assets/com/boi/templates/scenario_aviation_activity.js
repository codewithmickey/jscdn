var scenario_aviation_activity = function(dom,data){

    var evts= new Events();
    var scenario_aviation_activity_audio_flag_counter=0;
    var SCENARIO_AVIATION_ACTIVITY_FLAG = false;
    //var _html = dom
    ...
    _html.find(document).ready(function(){
        ...
        _html.find(".slide21_submit").click(function(){
            ...
            if(!$(".slide21_submit").hasClass("scenario_aviation_activity_audio_flag")){
                _html.find('.slide21_submit').addClass('scenario_aviation_activity_audio_flag');
                scenario_aviation_activity_audio_flag_counter++;
            }
            ...
            dispatchScenarioAviationActivity();
        });
    });

    function dispatchScenarioAviationActivity(){
        if(scenario_aviation_activity_audio_flag_counter == 1){
            SCENARIO_AVIATION_ACTIVITY_FLAG = true;
            evts.dispatchEvent("SCENARIO_AVIATION_ACTIVITY", SCENARIO_AVIATION_ACTIVITY_FLAG);
        }
    }
