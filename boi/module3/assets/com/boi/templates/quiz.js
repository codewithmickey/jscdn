var quiz = function(dom,data){
    ...
    function construct(){
        ...
        _html.find('.quiz__section__main_mod3').html(data.content)
    ...
    construct()
        ...
        _html.find('#start__quiz').on('click', function(e) {
            ...
            _html.find('quiz_prev_mod3').addClass('disabled');
            $('img.quiz_prev_mod3').attr("tabindex", -1);
            $('footer').hide()
            $('nextback').hide()
        ...
        function loadQuiz() {
            ...
            if(attemptedQuestionCounter == nCurrentQuestion && retakeQuizFlag == false){
                $('.quiz_next_mod3').addClass('disabled');
                $('img.quiz_next_mod3').attr("tabindex", -1);
            }else{
                $('.quiz_next_mod3').removeClass('disabled');
                $('img.quiz_next_mod3').attr("tabindex", 0);
            }
        ...
        _html.find('#review__quiz').on('click', function(e){
            ...
            $('.quiz_prev_mod3').addClass('disabled');
            $('img.quiz_prev_mod3').attr("tabindex", -1);
            $('.quiz_next_mod3').removeClass('disabled');
            $('img.quiz_next_mod3').attr("tabindex", 0);
            loadQuiz();
        ...
        _html.find('#submit_question').on('click', function(e) {
            ...
            if(validate()) {
                ...
                if(submittedQuestionCounter == 1){
                    $('.pagination_circle1_mod3').css("background", "#3087C8");
                    $('.pagination_circle2_mod3').css("background", "#ffffff");
                    $('.pagination_circle3_mod3').css("background", "#ffffff");
                    $('.pagination_circle4_mod3').css("background", "#ffffff");
                    $('.pagination_circle5_mod3').css("background", "#ffffff");
                    $('.pagination_circle6_mod3').css("background", "#ffffff");
                }else if(submittedQuestionCounter == 2){
                    $('.pagination_circle1_mod3').css("background", "#3087C8");
                    $('.pagination_circle2_mod3').css("background", "#3087C8");
                    $('.pagination_circle3_mod3').css("background", "#ffffff");
                    $('.pagination_circle4_mod3').css("background", "#ffffff");
                    $('.pagination_circle5_mod3').css("background", "#ffffff");
                    $('.pagination_circle6_mod3').css("background", "#ffffff");
                    ...
                    $('.pagination_circle1_mod3').css("background", "#3087C8");
                    $('.pagination_circle2_mod3').css("background", "#3087C8");
                    $('.pagination_circle3_mod3').css("background", "#3087C8");
                    $('.pagination_circle4_mod3').css("background", "#ffffff");
                    $('.pagination_circle5_mod3').css("background", "#ffffff");
                    $('.pagination_circle6_mod3').css("background", "#ffffff");
                    ...
                    $('.pagination_circle2_mod3').css("background", "#3087C8");
                    $('.pagination_circle3_mod3').css("background", "#3087C8");
                    $('.pagination_circle4_mod3').css("background", "#3087C8");
                    $('.pagination_circle5_mod3').css("background", "#ffffff");
                    $('.pagination_circle6_mod3').css("background", "#ffffff");
                    ...
                    $('.pagination_circle3_mod3').css("background", "#3087C8");
                    $('.pagination_circle4_mod3').css("background", "#3087C8");
                    $('.pagination_circle5_mod3').css("background", "#3087C8");
                    $('.pagination_circle6_mod3').css("background", "#ffffff");
                    ...
                    $('.pagination_circle4_mod3').css("background", "#3087C8");
                    $('.pagination_circle5_mod3').css("background", "#3087C8");
                    $('.pagination_circle6_mod3').css("background", "#3087C8");
                }
            }
        });
        ...
        _html.find('#next_question').on('click', function(e) {
            ...
            if(!$("#next_question").hasClass("disabled")){
                ...
                if(validate()) {
                        ...
                        case "MCMS":
                            ...
                            if($("img").hasClass("disabled")){
                                ...
                                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex + 1 > 0){
                                    $("img.quiz_prev_mod3").removeClass("disabled");
                                    $('img.quiz_prev_mod3').attr("tabindex", 0);
                                }
                            }
                            break;
                    }
                    ...
                    $('.quiz_prev_mod3').removeClass('disabled');
                    $('img.quiz_prev_mod3').attr("tabindex", 0);
        ...
        _html.find('.quiz_prev_mod3').on('click', function(e){
            if(!$("img.quiz_prev_mod3").hasClass("disabled")){
                nCurrentQuestion--;

                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex == 0){
                    $("img.quiz_prev_mod3").addClass("disabled");
                    $('img.quiz_prev_mod3').attr("tabindex", -1);
                }
                $('#next_question').removeClass("hide")
        ...
        _html.find('.quiz_next_mod3').on('click', function(e){
            if(!$("img.quiz_next_mod3").hasClass("disabled") && retakeQuizFlag == false){
                nCurrentQuestion++;


                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex == 4){
                    $("img.quiz_next_mod3").addClass("disabled");
                    $('img.quiz_next_mod3').attr("tabindex", -1);
                }
                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex > 0){
                    $("img.quiz_prev_mod3").removeClass("disabled");
        ...
        function displayScoreBoard() {
            ...
            if(percentage>=80) {
                ...
                _html.find('#scoreboard__title_numbers').html('<p><b>This is the end of the quiz.</b></p><p><b>To pass you need a minimum of 5 correct answers.</b></p>');
                _html.find('#scoreboard__title_text').html('<p>Given below is your score.</p>');
                _html.find('.pcc_percents_wrapper').html(''+counter+' of '+jsonData.Assessment.length+'');
        ...
        _html.find('#retake__quiz').on('click', function(e) {
            ...
            $('.quiz_prev_mod3').addClass('disabled');
            $('.pagination_circle1_mod3').css("background", "#ffffff");
            $('.pagination_circle2_mod3').css("background", "#ffffff");
            $('.pagination_circle3_mod3').css("background", "#ffffff");
            $('.pagination_circle4_mod3').css("background", "#ffffff");
            $('.pagination_circle5_mod3').css("background", "#ffffff");
        ...
        function validate() {
            ...
            switch (jsonData.Assessment[nCurrentQuestion].type) {
                case "MCSS":
                    ...
                    // $('.quiz_custom_submit_mod3').removeClass("disabled");
                    // $('.quiz_custom_submit_mod3').prop('disabled', false);
                    break;
                case "MCMS":
        ...
        $.getJSON( "assets/json/config.json", function( data ) {
            $('.quiz_prev_mod3, .quiz_next_mod3').unbind('keypress').bind('keypress', function(e){
