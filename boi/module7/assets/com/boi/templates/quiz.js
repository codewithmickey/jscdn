var quiz = function(dom,data){
    ...
    function construct(){
        ...
        _html = dom
        _html.find('.quiz__section__main_mod7').html(data.content)
    ...
    construct()
        ...
        _html.find('#start__quiz').on('click', function(e) {  
            ...
            _html.find('quiz_prev_mod7').addClass('disabled');
            $('img.quiz_prev_mod7').attr("tabindex", -1);
            $('footer').hide()
            $('nextback').hide()
        ...
        function loadQuiz() {
            ...
            if(attemptedQuestionCounter == nCurrentQuestion && retakeQuizFlag == false){
                $('.quiz_next_mod7').addClass('disabled');
                $('img.quiz_next_mod7').attr("tabindex", -1);
            }else{
                $('.quiz_next_mod7').removeClass('disabled');
                $('img.quiz_next_mod7').attr("tabindex", 0);
            }
        ...
        _html.find('#review__quiz').on('click', function(e){
            ...
            $('.quiz_prev_mod7').addClass('disabled');
            $('img.quiz_prev_mod7').attr("tabindex", -1);
            $('.quiz_next_mod7').removeClass('disabled');
            $('img.quiz_next_mod7').attr("tabindex", 0);
            loadQuiz();
        ...
        _html.find('#submit_question').on('click', function(e) {
            ...
            if(validate()) {
                ...
                if(submittedQuestionCounter == 1){
                    $('.pagination_circle1_mod7').css("background", "#3087C8");
                    $('.pagination_circle2_mod7').css("background", "#ffffff");
                    $('.pagination_circle3_mod7').css("background", "#ffffff");
                    $('.pagination_circle4_mod7').css("background", "#ffffff");
                    $('.pagination_circle5_mod7').css("background", "#ffffff");
                    $('.pagination_circle6_mod7').css("background", "#ffffff");
                }else if(submittedQuestionCounter == 2){
                    $('.pagination_circle1_mod7').css("background", "#3087C8");
                    $('.pagination_circle2_mod7').css("background", "#3087C8");
                    $('.pagination_circle3_mod7').css("background", "#ffffff");
                    $('.pagination_circle4_mod7').css("background", "#ffffff");
                    $('.pagination_circle5_mod7').css("background", "#ffffff");
                    $('.pagination_circle6_mod7').css("background", "#ffffff");
                    ...
                    $('.pagination_circle1_mod7').css("background", "#3087C8");
                    $('.pagination_circle2_mod7').css("background", "#3087C8");
                    $('.pagination_circle3_mod7').css("background", "#3087C8");
                    $('.pagination_circle4_mod7').css("background", "#ffffff");
                    $('.pagination_circle5_mod7').css("background", "#ffffff");
                    $('.pagination_circle6_mod7').css("background", "#ffffff");
                    ...
                    $('.pagination_circle2_mod7').css("background", "#3087C8");
                    $('.pagination_circle3_mod7').css("background", "#3087C8");
                    $('.pagination_circle4_mod7').css("background", "#3087C8");
                    $('.pagination_circle5_mod7').css("background", "#ffffff");
                    $('.pagination_circle6_mod7').css("background", "#ffffff");
                    ...
                    $('.pagination_circle3_mod7').css("background", "#3087C8");
                    $('.pagination_circle4_mod7').css("background", "#3087C8");
                    $('.pagination_circle5_mod7').css("background", "#3087C8");
                    $('.pagination_circle6_mod7').css("background", "#ffffff");
                    ...
                    $('.pagination_circle4_mod7').css("background", "#3087C8");
                    $('.pagination_circle5_mod7').css("background", "#3087C8");
                    $('.pagination_circle6_mod7').css("background", "#3087C8");
                }
            }
        });
        ...
        _html.find('#next_question').on('click', function(e) {
            ...
            if(!$("#next_question").hasClass("disabled")){
                ...
                if(validate()) {
                        ...
                        case "MCMS":
                            ...
                            if($("img").hasClass("disabled")){
                                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex + 1 > 0){
                                    $("img.quiz_prev_mod7").removeClass("disabled");
                                    $('img.quiz_prev_mod7').attr("tabindex", 0);
                                }
                            }
                            break;
                    }
                    ...
                    $('.quiz_prev_mod7').removeClass('disabled');
                    $('img.quiz_prev_mod7').attr("tabindex", 0);
        ...
        _html.find('.quiz_prev_mod7').on('click', function(e){
            if(!$("img.quiz_prev_mod7").hasClass("disabled")){
                nCurrentQuestion--;
                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex == 0){
                    $("img.quiz_prev_mod7").addClass("disabled");
                    $('img.quiz_prev_mod7').attr("tabindex", -1);
                }
                $('#next_question').removeClass("hide")
        ...
        _html.find('.quiz_next_mod7').on('click', function(e){
            if(!$("img.quiz_next_mod7").hasClass("disabled") && retakeQuizFlag == false){
                nCurrentQuestion++;
                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex == 4){
                    $("img.quiz_next_mod7").addClass("disabled");
                    $('img.quiz_next_mod7').attr("tabindex", -1);
                }
                if(jsonData.Assessment[nCurrentQuestion].nCurrentQuestionIndex > 0){
                    $("img.quiz_prev_mod7").removeClass("disabled");
        ...
        function displayScoreBoard() {
            ...
            if(percentage>=80) {
                ...
                _html.find('#scoreboard__title').html('<p tabindex="0"><b>You have completed the module quiz.</b></p>');
                ...
                $('#scoreboard__title').attr('tabindex',0)
                _html.find('#scoreboard__title').html('<p><b>This is end of the quiz.</b></p><p><b>To pass you need a minimum of 5 correct answers.</b</p>');
                _html.find('#scoreboard__title_text').html('<p>Given below is your score.</p>');
                _html.find('.pcc_percents_wrapper').html(''+counter+' of '+jsonData.Assessment.length+'');
        ...
        function loadProgress(percentage) {
            ...
            //var classes = 72;
            // Previous Code
            // var deg1 = Math.round(deg);
            // switch(deg1)
            // {
            //     case 60:
            //         _html.find('.pcc-percents-wrapper span').html('1 of 6');
            //     break;
            //     case 120:
            //         _html.find('.pcc-percents-wrapper span').html('2 of 6'); 
            //     break;      
            //     case 180:
            //        _html.find('.pcc-percents-wrapper span').html('3 of 6'); 
            //     break;     
            //     case 240:
            //         _html.find('.pcc-percents-wrapper span').html('4 of 6'); 
            //     break;
            //      case 300:
            //         _html.find('.pcc-percents-wrapper span').html('5 of 6'); 
            //     break;
            //     case 360:
            //         _html.find('.pcc-percents-wrapper span').html('6 of 6'); 
            //     break;
            //     default:
            //     _html.find('.pcc-percents-wrapper span').html('0 of 6'); 
            // }
            // Previous Code
        }
        ...
        _html.find('#retake__quiz').on('click', function(e) {
            ...
            $('footer').show()
            $('nextback').show()
            // $('.nav-link[menu-data="Back"]').removeClass('disabled');
            $('a[menu-data = '+'Back'+']').removeClass('hide');
            $('a[menu-data = '+'Next'+']').removeClass('hide');
            $('.quiz_prev_mod7').addClass('disabled');
            $('.pagination_circle1_mod7').css("background", "#ffffff");
            $('.pagination_circle2_mod7').css("background", "#ffffff");
            $('.pagination_circle3_mod7').css("background", "#ffffff");
            $('.pagination_circle4_mod7').css("background", "#ffffff");
            $('.pagination_circle5_mod7').css("background", "#ffffff");
        ...
        $(document).ready(function() {
            $.getJSON( "assets/json/config.json", function( data ) {
                $('.quiz_prev_mod7, .quiz_next_mod7').unbind('keypress').bind('keypress', function(e){
