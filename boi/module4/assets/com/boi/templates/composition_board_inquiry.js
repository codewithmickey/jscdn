var composition_board_inquiry = function(dom,data){
    ...
    var evts= new Events();
    var composition_board_inquiry_audio_flag_counter = 0;
    var COMPOSITION_BOARD_INQUIRY_FLAG= false;
    //var _html = dom
    ...
    _html.find(".intro_parent1_slide11_1").click(function () {
        if(!$(".intro_parent1_slide11_1").hasClass("composition_board_inquiry_audio_flag")){
            _html.find('.intro_parent1_slide11_1').addClass('composition_board_inquiry_audio_flag');
            composition_board_inquiry_audio_flag_counter++;
        }
        ...
        dispatchCompositionBoardInquiry();
    });
    
    _html.find(".intro_parent1_slide11_2").click(function () {
        if(!$(".intro_parent1_slide11_2").hasClass("composition_board_inquiry_audio_flag")){
            _html.find('.intro_parent1_slide11_2').addClass('composition_board_inquiry_audio_flag');
            composition_board_inquiry_audio_flag_counter++;
        }
    ...
    _html.find(".intro_parent1_slide11_3").click(function () {
        if(!$(".intro_parent1_slide11_3").hasClass("composition_board_inquiry_audio_flag")){
            _html.find('.intro_parent1_slide11_3').addClass('composition_board_inquiry_audio_flag');
            composition_board_inquiry_audio_flag_counter++;
        }
    ...
    _html.find(".intro_parent1_slide11_4").click(function () {
        if(!$(".intro_parent1_slide11_4").hasClass("composition_board_inquiry_audio_flag")){
            _html.find('.intro_parent1_slide11_4').addClass('composition_board_inquiry_audio_flag');
            composition_board_inquiry_audio_flag_counter++;
        }
    ...
    _html.find(".intro_parent1_slide11_5").click(function () {
        if(!$(".intro_parent1_slide11_5").hasClass("composition_board_inquiry_audio_flag")){
            _html.find('.intro_parent1_slide11_5').addClass('composition_board_inquiry_audio_flag');
            composition_board_inquiry_audio_flag_counter++;
        }
    ...
    _html.find(".intro_parent1_slide11_6").click(function () {
        if(!$(".intro_parent1_slide11_6").hasClass("composition_board_inquiry_audio_flag")){
            _html.find('.intro_parent1_slide11_6').addClass('composition_board_inquiry_audio_flag');
            composition_board_inquiry_audio_flag_counter++;
        }
    ...
    function dispatchCompositionBoardInquiry(){
        if(composition_board_inquiry_audio_flag_counter == 6){
            COMPOSITION_BOARD_INQUIRY_FLAG = true;
            evts.dispatchEvent("COMPOSITION_BOARD_INQUIRY",COMPOSITION_BOARD_INQUIRY_FLAG);
        }
    }
