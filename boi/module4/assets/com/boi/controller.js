(function(app) {
    ...
    function startApplication(){
        ...
        oContentLoader.evts.addEventListener("CONVERNING_ORDER_CLICKED", function(a,b,c){
            if(c==true){
                screen5_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("COMPOSITION_BOARD_INQUIRY_CLICKED", function(a,b,c){
            if(c==true){
                screen6_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("HEAD_OF_MISSION_REPORT_CLICKED", function(a,b,c){
            if(c==true){
                screen7_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("CONTENTS_OF_THE_HOM_REPORT_CLICKED", function(a,b,c){
            if(c==true){
                screen8_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("ANCIDENT_QUALIFY_OCCUPATIONAL_ACCIDENT_CLICKED", function(a,b,c){
            if(c==true){
                screen9_flag = true;
            }
            setEnableMenu();
        ...
        oContentLoader.evts.addEventListener("UNHQ_BOARD_OF_INQUIRY_CLICKED", function(a,b,c){
            if(c==true){
                screen11_flag = true;
            }
            setEnableMenu();
        ...
        document.addEventListener('swiped-left', function(e) {
            if(nCurrentPage <  nTotalPages-1){
                ...
                // counter++;
                setPageNumber();
                _html.find('.transcript_data_mod4').addClass("hide");
                transcriptOn = false;
                // loadPage();
            }
        });
    ...
    function createNavigation(){
        ...
        oNavigation.evts.addEventListener("NAV_CLICKED",function(a,b,c){
            ...
            if(!isNaN(c) && !$('a[menu-data = '+c+']').hasClass("disabled"))
            {
                ...
                $('.transcript_data_mod4').addClass("hide");
                $('.close_text_area_mod4').addClass("hide");
                ...
                loadPage()
                if(screen12_flag == false && nCurrentPage==12){
                    setTimeout(function(){
            ...
            }else if(c == "Glossary")
            {
                ...
                $('ul.glossary_tabs_ul li:first').addClass('current_glossary_key');
        ...
        oAudioPlayer.evts.addEventListener("AUDIO_END_FLAG", function(a, b, c){
            ...
            if(c== true && nCurrentPage==1){
                ...
                screen4_flag = true;
            }else if(c== true && nCurrentPage==10){
                screen10_flag = true;
    ...
    function activateAudioPlayer(){
        $('.click_cursor_unmute, .click_cursor_mute, .click_cursor_play, .click_cursor_pause, .click_cursor_replay, .click_cursor_text, .close_text_area_mod4').on('keypress', function(e){
            if(e.type === 'keypress' && e.keyCode != 13 && e.keyCode != 32 && e.keyCode != 9){
                return false;
            } 
            if(e.keyCode !=9){
      ...
      _html.find('.click_cursor_text').click(function(){
            if(!transcriptOn){
                $('.transcript_data_mod4  > p').html('');
                $('.transcript_data_mod4').removeClass("hide");
                $('.transcript_data_mod4 > p').append(jsonData.pages[nCurrentPage].data.transcript);
                $('.close_text_area_mod4').removeClass("hide");
        ...
        $('.close_text_area_mod4').click(function(){
            $('.transcript_data_mod4').addClass("hide");
            $('.close_text_area_mod4').addClass("hide");
            $('.audio__control').removeClass("hide");
            transcriptOn = false;
